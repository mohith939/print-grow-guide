          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-display font-bold text-xl">SSS Graphics</span>
                <span className="text-xs text-primary-foreground/60 tracking-wider">PREMIUM PRINT & BRANDING</span>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+918639471849" className="text-primary-foreground/70 hover:text-accent transition-colors text-sm">
                  +91 86394 71849
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent shrink-0" />
                <a href="mailto:info@sssgraphics.com" className="text-primary-foreground/70 hover:text-accent transition-colors text-sm">
